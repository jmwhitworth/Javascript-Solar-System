...
import CameraGroup from './solarsystem/CameraGroup';
import Star from './solarsystem/Star';
...
export default class SolarSystem
{
    ...
    /**
     * Returns the 'name' attribute assigned to the instance of the class called
     * @returns {String} Name
     */
    name()
    {
